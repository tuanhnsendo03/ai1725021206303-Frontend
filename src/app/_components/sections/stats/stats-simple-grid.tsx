          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Drive Your Journey with Ultimate Comfort and Reliability
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience the pinnacle of professional car rental services tailored to meet your unique travel needs.
              </p>
            </div>
